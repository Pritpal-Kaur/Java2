...
final String GET_ALL_LOCATIONS = "SELECT * FROM Location";
 ...
 final String ADD_LOCATION = "INSERT INTO Location(name, description, addressInfo, latitude, longitude) "
                + "VALUES(?,?,?,?,?)";
...
final String GET_LOCATIONS_BY_SUPER = "SELECT DISTINCT l.id, l.name, l.description, l.addressInfo, l.latitude, l.longitude "
                + "FROM sighting s "
                + "JOIN Location l ON s.locationId = l.id "
                + "WHERE s.heroId = ?";
        return jdbc.query(GET_LOCATIONS_BY_SUPER, new LocationMapper(), hero.getId());
    }
